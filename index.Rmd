...
4. Théorie + exercices après chaque concept
...
La manipulation de ces données demande beaucoup de temps.
...
On effectue la même opération sur toutes les colonnes de `df`.
...
Dans ce premier examole, on veux ajouter la valeur de 1 à tous les éléments d'un vecteur numérique.
...
coords <- read_csv("/home/pmassicotte/Downloads/Capital_Bike_Share_Locations.csv") %>% 
  janitor::clean_names() %>% 
