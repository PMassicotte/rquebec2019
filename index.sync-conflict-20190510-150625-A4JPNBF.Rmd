...
Il est intéressant de pouvoir être explicite sur la classe des données attendues. Dans le prochain cas, un erreur est généré, car la fonction `mean()` retourne une valeur de type *double* alors que je spécifie que je devrais reçevoir un *integer*.
